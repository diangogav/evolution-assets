...
export function renderInstallReadme({ lang, cards }) {
	...
	return [
		...
		"",
		"To get it, download upstream's pack and add it as an expansion:",
		"",
		"  https://cdn02.moecube.com/ygopro-rush-duel/archive/ygopro-rush-duel-master.ypk",
		"",
		"then drop the .ypk into your MDPro3 Expansions folder (or import it from",
		"Settings, which accepts .ypk and .zip).",
		"",
